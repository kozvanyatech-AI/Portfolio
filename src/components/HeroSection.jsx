function HeroSection() {
  return (
    <section
      id="home"
      className="relative pt-32 pb-20 md:pt-52 md:pb-40 lg:pt-64 lg:pb-48 overflow-hidden"
    >
      ...
      <div className="container-custom relative z-10">
        <div className="flex flex-col items-center justify-center text-center space-y-8 md:space-y-10 lg:space-y-12">
          ...
          <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold leading-tight tracking-tight max-w-5xl text-white animate-fade-in">
            ...
            <span className="block mt-3">
              <span className="relative inline-block">
                <span
                  className="absolute inset-0 bg-gradient-to-r from-primary-400 via-primary-500 to-primary-600 opacity-0 animate-pulse-slow"
          ...
          {/* Subheading */}
          <p
            className="text-lg sm:text-xl md:text-2xl text-gray-400 max-w-3xl leading-relaxed font-light tracking-wide animate-fade-in"
            style={{ animationDelay: "0.2s" }}
          >
            We build modern, scalable digital products for startups and
            businesses ready to transform their ideas into reality.
          </p>

          {/* CTA Buttons */}
          <div
            className="flex flex-col sm:flex-row gap-4 sm:gap-5 pt-6 md:pt-10 animate-fade-in w-full sm:w-auto sm:justify-center"
          ...
          {/* Trust/Social Proof */}
          <div
            className="pt-12 md:pt-16 lg:pt-20 animate-fade-in w-full"
            style={{ animationDelay: "0.6s" }}
          >
            <p className="text-xs sm:text-sm text-gray-500 uppercase tracking-widest mb-6 md:mb-8 font-medium">
            ...
            <div className="flex items-center justify-center gap-6 md:gap-10 flex-wrap px-4">
              {[
                ...
                >
                  ...
                  <span className="text-sm md:text-base text-gray-400 hidden sm:inline group-hover:text-gray-300 transition-colors">
                    {company.name}
                  </span>
                </div>
              ))}
