...
function AboutSection() {
  ...
  return (
    <section id="about" ref={ref} className={`section-spacing relative overflow-hidden border-t border-white/10 transition-smooth ${isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
      ...
      <div className="container-custom relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-20 items-center">
          ...
          <div className="flex justify-center md:justify-start">
            <div className="relative w-72 h-72 md:w-96 md:h-96">
              ...
              <div className="absolute -bottom-6 -right-6 glass-effect border-primary-400/30 rounded-2xl p-5 w-56 shadow-2xl hidden md:block group/float hover:bg-white/10 transition-all duration-300">
                <p className="text-xs text-gray-500 uppercase tracking-widest mb-2 font-medium">Building Since</p>
          ...
          <div className="space-y-10">
            {/* Subtitle */}
            <div>
              <p className="text-xs uppercase tracking-widest text-primary-400 font-semibold mb-4">About Us</p>
            ...
            <div className="space-y-6 text-gray-300">
              <p className="text-xl leading-relaxed font-light">
                Software Engineer with <span className="font-semibold text-primary-300">5+ years of experience</span> building scalable applications and leading high-performing development teams.
              </p>
              <p className="text-gray-400 text-lg leading-relaxed font-light">
                Expert in full-stack development and modern technologies, passionate about creating exceptional digital experiences and mentoring the next generation of developers.
              </p>
              <p className="text-gray-450 text-lg leading-relaxed font-light">
                Focused on product development, system architecture, performance optimization, and transforming complex business challenges into intelligent digital solutions.
              </p>
            </div>

            {/* Skills/Expertise */}
            <div className="pt-4">
              <p className="text-xs uppercase tracking-widest text-gray-500 font-semibold mb-5">Core Expertise</p>
            ...
            <div className="pt-4 space-y-6">
              <div>
                <p className="text-xs uppercase tracking-widest text-gray-500 font-semibold mb-4">Connect</p>
                <div className="flex gap-4">
                  {[
                    { icon: 'in', label: 'LinkedIn', color: 'hover:text-blue-400' },
                    { icon: 'gh', label: 'GitHub', color: 'hover:text-gray-300' },
                    { icon: 'tw', label: 'Twitter', color: 'hover:text-sky-400' },
                  ].map((social) => (
                    <a
                      key={social.label}
                      href="#"
